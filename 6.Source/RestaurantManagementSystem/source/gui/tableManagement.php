...
<link rel="stylesheet" href="../css/style.css" type="text/css"
	media="all" />
<link rel="stylesheet" href="../css/tableManagement.css" type="text/css"
	media="all" />
...
<script src="../js/tableManagementFunc.js" type="text/javascript"></script>
	...
	<div id="page" class="shell">
		...
		<div id="main">
			...
			<div id="menuDiv" class="menu" style="display: none">
				<ul>
					<li><a href="javascript:booking()"><img
							src="../css/images/plusIcon.png" title="Đặt chỗ" /> </a></li>
					<li><a href="javascript:showTableList()"><img
							src="../css/images/tableIcon.png" title="Danh sách bàn" /> </a></li>
				</ul>
			</div>
			<!-- END Menu -->
			<div class="main-content">
				<div id="main-header">QUẢN LÝ BÀN ĂN</div>
				<!-- Search food table -->
				<div class="search-table">
					<table>
						...
						<tr>
							<td>Khu vực</td>
							<td><?php echo GUIGenerator::htmlShowAreaSelect();?>
							</td>
							<td>Tình trạng</td>
						...
						<tr>
							<td>Từ</td>
							<td><input type="text" id="seachFromDtPker"></input>
							</td>
							<td>Đến</td>
							<td><input type="text" id="seachToDtPker"></input><br />
							</td>
						</tr>
						<tr>
							<td></td>
							<td></td>
							<td><button onclick="javascript:searchTable()">Tìm kiếm</button>
							</td>
						</tr>
					</table>
