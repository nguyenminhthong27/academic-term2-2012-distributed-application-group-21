...
var left=pos[0];if(this.align=='right'){var offset=getWidth(this.title)-getWidth(this.body);left+=offset;}}
...
var subscribe=document.getElementById('subscribe-feeds');if(subscribe){new GhostlyMenu(subscribe,align);}
